                                        ...
                                        <div class="ml-4 flex flex-1 flex-col sm:ml-6">
                                            <div>
                                                <div class="flex justify-between">
                                                    ...
                                                    <p class="ml-4 text-sm font-medium text-gray-900">₱{{ number_format($cart->total, '2', '.', ',',
                                                        ) }}</p>
                                                </div>
                                                <p class="mt-1 text-sm text-gray-500">{{ $cart->product->dprice }}</p>
                                            ...
                                            <div class="mt-4 flex flex-1 items-end justify-between">
                                                ...
                                                <div class="ml-4">
                                                    <a href="{{ route('cart.remove', ['id' => $cart->id]) }}" class="text-sm font-small text-indigo-600 hover:text-indigo-500">
                                                        Remove
                                                    </a>
                                                </div>
                                            </div>
