<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('rewards')" :active="request()->routeIs('rewards')">
                {{ __('Rewards') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('genealogy')" :active="request()->routeIs('genealogy')">
                {{ __('Genealogy') }}
            </x-responsive-nav-link>
            @if (auth()->user()->is_stockist)
            <x-responsive-nav-link :href="route('stockist')" :active="request()->routeIs('stockist')">
                {{ __('Stockist') }}
            </x-responsive-nav-link>
            @else
