            ...
            <div class="bg-white">
                <div class="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8">
                    <div class="flex items-center justify-between px-4 sm:px-6 lg:px-0">
                        ...
                        <p class="text-sm font-medium text-rose-600">{{ auth()->user()->points }} points</p>
                    </div>
                        ...
                        <div class="relative -mb-6 w-full overflow-x-auto pb-6">
                            <ul role="list"
                                ...
                                @foreach ($items as $reward)
                                    <li class="mt-2 inline-flex w-64 flex-col text-center lg:w-auto" style="opacity: {{ auth()->user()->points < $reward->points ? '0.3' : '1' }}">
